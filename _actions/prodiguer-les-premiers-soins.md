...
---
**Conditions** Vous tenez ou portez des [instruments de guérisseur](../équipements/outils-de-guérisseur.md)
...
**Succès** Si vous tentez de la stabiliser, la créature n’a plus l’état mourant (mais elle reste [inconsciente](../conditions/inconscient.md)). Si vous tentez de stopper l’hémorragie, la créature effectue un test nu pour mettre un terme au saignement.
