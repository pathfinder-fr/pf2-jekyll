...
layout: dons
---
Vous vous précipitez en avant, déplaçant les ennemis sur le côté pour atteindre vos adversaires. Vous [Marchez rapidement](../actions/marcher-rapidement.html), en tenant de vous déplacer parr l'emplacement de vos ennemis et effectuez une [Frappe](../actions/frapper.html) en mêlée.
...
Vous pouvez utiliser use ce don pour [Creuser](../actions/creuser.html), [Escalader](../actions/escalader.html), [Voler](../actions/voler.html) ou [Nager](../actions/nager.html) plutôt que vous précipiter si vous bénéficiez du type de déplacement correspondant.
