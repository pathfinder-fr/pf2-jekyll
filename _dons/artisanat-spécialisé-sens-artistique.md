...
title: Artisanat spécialisé (Sens artistique)
titleEn: Specialty Crafting (Artistry)
id: 22HUfCajd6IkATOR
urlFr: https://gitlab.com/pathfinder-fr/foundryvtt-pathfinder2-fr/-/blob/master/data/feats/22HUfCajd6IkATOR.htm
urlEn: https://gitlab.com/hooking/foundry-vtt---pathfinder-2e/-/blob/master/packs/data/feats.db/specialty-crafting-artistry.json
layout: dons
---
...
**Exemples d'objet** Objets d'art, y compris les bijoux
